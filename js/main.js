document.addEventListener("DOMContentLoaded", () => {
    ...
    const pageTranslations = {
        ...
        "contacto.html": {
            en: {
                ".feature-grid .eyebrow": "What you can ask about",
                ".feature-grid .section-title": "Areas where I can help from the first conversation",
            ...
            es: {
                ".feature-grid .eyebrow": "Qué puedes consultar",
                ".feature-grid .section-title": "Áreas en las que puedo ayudarte desde la primera conversación",
    ...
    const setLanguage = (lang) => {
        ...
        const translationsForPage = pageTranslations[currentPage]?.[lang];
